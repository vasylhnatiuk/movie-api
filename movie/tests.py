...
class PersonListAPIViewTestCase(TestCase):
    ...
    def test_create_person(self):
        new_person_data = {"name": "Charlie Brown", "specialization": Person.ACTOR}
...
class MovieListAPIViewTestCase(TestCase):
    ...
    def test_get_movies(self):
        ...
        director = Person.objects.create(
            name="Jane Smith", specialization=Person.DIRECTOR
        )
...
class MovieDetailAPIViewTestCase(TestCase):
    def setUp(self):
        ...
        self.movie = Movie.objects.create(
            title="Movie 1", description="Description 1", duration=120, year=2022
        )
